  ...
  return (
    <header className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white p-4 shadow-md">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <h1 className="text-2xl font-bold">CaribeSupply S.A.S.</h1>
...
function Auth({ onLogin }) {
  ...
  function handleLogin(e) {
    e.preventDefault();
    const stored = JSON.parse(localStorage.getItem("caribesupply_user") || "null");
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <footer className="bg-slate-800 text-white p-4 mt-8">
        <div className="max-w-6xl mx-auto text-sm">© {new Date().getFullYear()} CaribeSupply S.A.S. - Proyecto Final. Sitio demo con funciones simuladas y APIs integrables.</div>
      </footer>
    </div>
  );
}